...
class Bomber(object):
    ...
    def func4(self):
        ...
        browser.find_element_by_xpath('//*[@id="ap_customer_name"]').send_keys('Mike99887')
    ...
    def func7(self):
        ...
        browser.find_element_by_xpath('/html/body/div/div[4]/form/div/div[1]/div[2]/div[1]/input').send_keys('张喜爱')
    ...
    #     browser.find_element_by_xpath('//*[@id="username5"]').send_keys('张喜爱')
    ...
    def func14(self):
        ...
        browser.find_element_by_xpath('//*[@id="loginPasswordPage"]/div[2]/div/a').click()
        browser.find_element_by_xpath('//*[@id="signupphone"]').send_keys(self.phone)
        browser.find_element_by_xpath('//*[@id="signupPage"]/div[2]/form/div[2]/button').click()
        # // *[ @ id = "loginPasswordPage"] / div[2] / div / a
        time.sleep(5)
        browser.quit()
